...
module.exports = ( function() {
    router.post('/registrar', async function(req, res) {
        ...
        await config.dbInsert("insert into usuarios values (null, ?, ?, ?)", [nome, senha, email]);

        var userID = await config.dbGetSingleRow("select (idUsuario) from usuarios where username=?", [nome]);
